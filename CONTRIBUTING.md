...
![The Model-View-Controller](_docs/structure/MVC.png)

### How errors are handled

Model-related errors are logged in model.log (Model::printLog)

Controller-related errors are logged in controller.log (Controller::printLog)

Views display errors generated by the controller (Controller::setState)
